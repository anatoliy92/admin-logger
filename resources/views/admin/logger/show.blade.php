    ...
    <div class="card">
        <div class="card-header">
          ...
          <div class="card-actions">
            <a href="{{ route('adminlogger::index') }}" class="w-100 pl-3 pr-3"><i class="fa fa-arrow-left"></i> Назад</a>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <span class="form-control">{{ $log->section->name_ru ?? array_get(config('adminlogger.modelsNames'), $log->model) ?? $log->model }}</span>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="pull-right">
                    {!! array_get(config('adminlogger.events'), $log->event) !!}
                  </div>
                </div>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
	                        ...
	                        @endif
												@else
													@if ($log->previous)
														@foreach ($log->previous as $followKey => $followValue)
															<tr>
																<td>{{ $followKey }}</td>
																<td>{!! $log->previous[$followKey] !!}</td>
																<td></td>
